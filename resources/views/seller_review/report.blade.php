                ...
                <div class="row">
                    <div class="col-12">
                        ...
                        <table class="table-borderless table-striped" aria-describedby="mydesc" id="table_list"
                               data-table="true" data-url="{{ route('seller-review.report',1) }}" data-click-to-select="true"
                            ...
                            <tr>
                                ...
                                <th scope="col" data-field="seller_name" data-sortable="true">{{ __('Seller') }}</th>
                                <th scope="col" data-field="buyer_name" data-align="center" data-sortable="true">{{ __('Buyer') }}</th>
                                <th scope="col" data-field="item_name"  data-sortable="true">{{ __('Item') }}</th>
