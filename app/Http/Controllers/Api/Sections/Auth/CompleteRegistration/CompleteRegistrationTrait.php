...
trait CompleteRegistrationTrait
{
    public function completeRegistration(Request $request)
    {
        try {
            ...
            return ResponseService::successResponse('╪ث┬ت├تظéش┬ت╪╣┬╛╪╖┬╖╪ت┬▓╪ث┬ت├تظéشظî╪╣┬ر╪╖┬ث╪ت┬ب ╪ث┬ت├تظéش┬ت╪╣┬╛╪╖┬╖╪ت┬ص╪ث┬ت├تظéشظî╪╣┬ر╪╖┬ث╪ت┬ت╪ث┬ت├تظéشظî╪╣┬ر╪╖┬ث╪ت┬ب╪ث┬ت├تظéش┬ت╪╣┬╛╪╖┬╖╪ت┬»╪ث┬ت├تظéشظî╪╣┬ر╪╖┬ت├تظéشظ ╪ث┬ت├تظéش┬ت╪╣┬╛╪╖┬╖╪ت┬»╪ث┬ت├تظéشظî╪╣┬ر╪╖┬ت├تظéشظ╪ث┬ت├تظéش┬ت╪╣┬╛╪╖┬╖╪ت┬▓╪ث┬ت├تظéش┬ت╪╣┬╛╪ث┬ت├تظéشظî├تظéش┌ّ╪ث┬ت├تظéش┬ت╪╣┬╛╪╖┬╖╪ت┬┤╪ث┬ت├تظéشظî╪╣┬ر╪╖┬ث╪ت┬ذ╪ث┬ت├تظéشظî╪╣┬ر╪╖┬ت├تظéشظ ╪ث┬ت├تظéش┬ت╪╣┬╛╪╖┬╖╪ت┬░╪ث┬ت├تظéشظî╪╣┬ر╪╖┬ت├تظéش┬ب╪ث┬ت├تظéش┬ت╪╣┬╛╪╖┬╖╪ت┬┤╪ث┬ت├تظéش┬ت╪╣┬╛╪╖┬╖╪ت┬»╪ث┬ت├تظéش┬ت╪╣┬╛╪╖┬╖╪ت┬╡', $user);
