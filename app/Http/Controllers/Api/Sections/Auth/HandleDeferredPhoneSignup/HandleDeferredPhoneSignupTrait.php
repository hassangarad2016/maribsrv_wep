...
namespace App\Http\Controllers\Api\Sections\Auth\HandleDeferredPhoneSignup;
...
trait HandleDeferredPhoneSignupTrait
{
    private function handleDeferredPhoneSignup(Request $request, string $firebaseId)
    {
        ...
        if ($existingVerifiedUser) {
            ResponseService::errorResponse('أ¢آ”آکأƒآ§أ¢آ•آھأ¢آ–آ‘أ¢آ•آھأکآ¯ أ¢آ•آھأکآ¯أ¢آ”آکأ‚آ„أ¢آ•آھأ¢آ–آ’أ¢آ”آکأƒآ©أ¢آ”آکأƒآ  أ¢آ”آکأƒآ أ¢آ•آھأ¢آ”آ‚أ¢آ•آھأکآ´أ¢آ”آکأ‚آ„ أ¢آ•آھأکآ°أ¢آ•آھأکآ¯أ¢آ”آکأ‚آ„أ¢آ”آکأ‚آپأ¢آ•آھأ¢آ•آ£أ¢آ”آکأ‚آ„أ¢آ•آھأƒآ® أ¢آ”آکأƒآ¨أ¢آ•آھأ¢آ–آ’أ¢آ•آھأکآ´أ¢آ”آکأƒآ« أ¢آ•آھأکآ²أ¢آ•آھأ¢آ”آ‚أ¢آ•آھأکآ´أ¢آ”آکأƒآ¨أ¢آ”آکأ‚آ„ أ¢آ•آھأکآ¯أ¢آ”آکأ‚آ„أ¢آ•آھأ‚آ»أ¢آ•آھأ‚آ«أ¢آ”آکأƒآھأ¢آ”آکأ‚آ„');
        }
        ...
        ResponseService::successResponse(
            'أ¢آ•آھأ¢آ”آ‚أ¢آ”آکأƒآ¨أ¢آ•آھأکآ²أ¢آ”آکأƒآ  أ¢آ•آھأکآ­أ¢آ”آکأ‚آ†أ¢آ•آھأ¢آ”آ¤أ¢آ•آھأکآ¯أ¢آ•آھأکآ© أ¢آ•آھأکآ¯أ¢آ”آکأ‚آ„أ¢آ•آھأکآµأ¢آ•آھأ¢آ”آ‚أ¢آ•آھأکآ¯أ¢آ•آھأکآ° أ¢آ•آھأکآ°أ¢آ•آھأ¢آ•آ£أ¢آ•آھأ‚آ» أ¢آ•آھأکآ¯أ¢آ”آکأ‚آ„أ¢آ•آھأکآ²أ¢آ•آھأکآµأ¢آ”آکأƒآ©أ¢آ”آکأƒآ© أ¢آ”آکأƒآ أ¢آ”آکأ‚آ† أ¢آ•آھأکآ¯أ¢آ”آکأ‚آ„أ¢آ•آھأ¢آ–آ’أ¢آ”آکأƒآ أ¢آ•آھأ¢آ–آ“',
            [
