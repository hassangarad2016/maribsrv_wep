...
namespace App\Http\Controllers\Api\Sections\Items\BuildStorePolicySummary;
...
trait BuildStorePolicySummaryTrait
{
     private function buildStorePolicySummary($store): ?string
     {
        ...
        return $lines->map(static fn ($line) => 'â•ھâ•–â”¬â•–â•ھطھâ”¬â••â•ھâ•–â”¬طھâ”œطھط¸آ€ط£â”¬ط´â•ھâ•–â”¬â•–â•ھâ•£â”¬â•› ' . $line)->implode("\n");
     }
}