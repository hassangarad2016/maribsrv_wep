...
namespace App\Http\Controllers\Api\Sections\Verification\SendVerificationRequest;
...
trait SendVerificationRequestTrait
{
        ...
        try {
            ...
            if (!empty($missingRequired)) {
                ResponseService::validationError(
                    __('â•ھط¯â”کآ„â•ھطµâ”کأ©â”کأھâ”کآ„ â•ھط¯â”کآ„â•ھط²â•ھط¯â”کآ„â”کأ¨â•ھط± â•ھط­â”کآ„â•ھâ–“â•ھط¯â”کأ â”کأ¨â•ھط±: :fields', ['fields' => implode(', ', $missingRequired)])
                );
            }
